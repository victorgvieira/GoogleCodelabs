...
class MainNetworkFake(var result: String) : MainNetwork {
    override suspend fun fetchNextTitle() = result // DONE: replace with `result`
}
...
class MainNetworkCompletableFake() : MainNetwork {
    ...
    override suspend fun fetchNextTitle() = completable.await() // DONE: replace with `completable.await()`
